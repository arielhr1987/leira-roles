...
(() => {
/*!**********************************************!*\
  !*** ./src/inline-edit-user-capabilities.js ***!
  \**********************************************/
  ...
  window.inlineEditUserCapabilities = {
        ...
        if (r) {
          if (-1 !== r.indexOf('<tr')) {
            ...
            row.hide().fadeIn(400, function () {
              ...
              row.find('.editinline_capabilities').attr('aria-expanded', 'false').focus();
    ...
    revert: function () {
      ...
      if (id) {
        ...
        $(this.what + id).show().find('.editinline_capabilities').attr('aria-expanded', 'false').focus();
      }
    },
    /**
...
/******/ })()
;
//# sourceMappingURL=inline-edit-user-capabilities.js.map